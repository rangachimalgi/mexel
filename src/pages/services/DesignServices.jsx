...
const DesignServices = () => {
  return (
    <div className="design-services">
      ...
      <p>2D and 3D mechanical design refer to the creation of digital models and drawings for mechanical systems, components, and products using computer-aided design (CAD) software.</p>
      ...
      <h2>Applications</h2>
      <p>2D and 3D mechanical design are used in Industrial equipment drawings and Custom product drawings.</p>
    </div>
  );
};
